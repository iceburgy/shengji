...
export const ShengJiApp = () => {
    ...
    return <div>
        {
            isSetName ? <GameScreen hostName={hostName} playerName={playerName}></GameScreen> : <LoginScreen hostName={hostName} setHostName={setHostName} playerName={playerName} setPlayerName={setPlayerName} setIsSetName={setIsSetName} showNotice={showNotice}></LoginScreen>
        }
    </div>
}